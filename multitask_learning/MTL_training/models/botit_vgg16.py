...
class BotitVGG16(nn.Module):
    def __init__(self, img_size, df):
        super(BotitVGG16, self).__init__()
        ...
        # Use only the feature extractor part of VGG16
        ...
        conv_output_size = img_size // 32  # VGG reduces size by a factor of 32
        self.flat_size = 512 * (conv_output_size ** 2)  # 512 is the output channels of VGG16's last conv layer
    ...
    def forward(self, x):
        # Pass input through VGG16's feature extractor
