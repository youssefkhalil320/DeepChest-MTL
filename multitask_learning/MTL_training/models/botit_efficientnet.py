...
class BotitEfficientNet(nn.Module):
    def __init__(self, img_size, df):
        super(BotitEfficientNet, self).__init__()
        ...
        # Output channels of EfficientNet's feature extractor
    ...
    def forward(self, x):
        # Pass input through EfficientNet's feature extractor
