...
class BotitMobileNet(nn.Module):
    def __init__(self, img_size, df):
        super(BotitMobileNet, self).__init__()
        ...
        # Use only the feature extractor part of MobileNetV2
        ...
        # Extract the feature dimension from MobileNetV2's classifier
    ...
    def forward(self, x):
        # Pass input through MobileNetV2's feature extractor
